...
<script src="resources/plugin/bootstrap-datetimepicker.min.js" type="text/javascript" charset="UTF-8"></script>
	<script>
	 	$(function(){
			...
			if(voice!=null&&voice!=""){
				...
				for(var i=0;i<voices.length;i++){
					$("#voices").children(".bianji").before('<span class="mr15">'+voices[i]+'<a href="javascript:;" class="glyphicon glyphicon-remove gray"></a></span>');
				}
				$("#yuyi_checkbox_box_update .yuyiYdy").show();
			}
			...
			if(music!=null&&music!=""){
				...
				for(var i=0;i<musics.length;i++){
					$("#musics").children(".bianji").before('<span class="mr15">'+musics[i]+'<a href="javascript:;" class="glyphicon glyphicon-remove gray"></a></span>');
				}
				$("#music_checkbox_box_update .musicYdy").show();
			}
		...
		function cancel(){
			window.location.href="advertiseGroupClass/list2.html?groupid=${groupclass.group_id}";
		}
	</script>
</head>
<body style="font-family:'微软雅黑';">
	...
	<div class="main-right">
			<!-- 正文 -->
			<form method="post" action="advertiseGroupClass/update2.html"  id="formtable">
			<input type="hidden" name="id" id="id" value="${groupclass.id}">
			<input type="hidden" name="group_id" id="group_id" value="${groupclass.group_id}">
			<input type="hidden" name="stuts" id="stuts" value="${groupclass.stuts}">
			<input type="hidden" name="user_id" id="user_id" value="${groupclass.user_id}">
			<input type="hidden" name="voice" id="voice" value="">
			<input type="hidden" name="music" id="music" value="">
			
			<div class="line-title"><span class="glyphicon glyphicon-list-alt"></span> 修改广告组</div>
				<div class="right-box">
					<div class="list-group">
						...
						<div class="list-group-item adgroup-add-body-box">
							<span class="red">*</span>
							广告组名称：
							<input type="text" name="group_name" id="group_name"  value="${groupclass.group_name }" class="form-control" ></div>
						...
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								...
								class="dib" id="zhibo_checkbox_ctrl_show">
										<input
									type="radio" name="media_group" value="0"<c:if test="${groupclass.media_group==0}">checked</c:if> >直播</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="shipin_checkbox_ctr2_show">
										<input
									type="radio" name="media_group" value="1"<c:if test="${groupclass.media_group==1}">checked</c:if> >短视频</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="dianbo_checkbox_ctr3_show">
										<input
									type="radio" name="media_group" value="2"<c:if test="${groupclass.media_group==2}">checked</c:if> >点播</label>
									&nbsp;&nbsp;&nbsp;
								</li>
								...
								<li class="list-group-item" id="dianbo_checkbox_box">
										<label  class="dib">
											<input class="groupCkQuanX" type="checkbox"   name="planting_media" value="0" >全部</label>
										<label class="dib">
						...
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								...
								class="dib" id="jingpin_checkbox_ctr1_hide">
										<input
									type="radio" name="commodity_orientation" value="0" <c:if test="${groupclass.commodity_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="jingpin_checkbox_ctr2_show">
										<input
									type="radio" name="commodity_orientation" value="1" <c:if test="${groupclass.commodity_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
							...
							<ul class="list-group">
								...
								class="dib" id="scene_checkbox_ctr1_hide">
										<input
									type="radio" name="scene_orientation" value="0" <c:if test="${groupclass.scene_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="scene_checkbox_ctr2_show">
										<input
									type="radio" name="scene_orientation" value="1"<c:if test="${groupclass.scene_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
							...
							<ul class="list-group" >
								...
								class="dib" id="face_checkbox_ctr1_hide">
										<input
									type="radio" name="facerecognition_orientation" value="0" <c:if test="${groupclass.facerecognition_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="face_checkbox_ctr2_show">
										<input
									type="radio" name="facerecognition_orientation" value="1"<c:if test="${groupclass.facerecognition_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
							...
							<ul class="list-group">
								...
								class="dib" id="emotion_checkbox_ctr1_hide">
										<input
									type="radio" name="emotion_orientation" value="0" <c:if test="${groupclass.emotion_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="emotion_checkbox_ctr2_show">
										<input
									type="radio" name="emotion_orientation" value="1" <c:if test="${groupclass.emotion_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
							...
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									...
									<label class="dib" id="yuyi_checkbox_ctrl_hide">
										<input type="radio" name="voice_orientation"  value="0" <c:if test="${groupclass.voice_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label class="dib" id="yuyi_checkbox_ctr2_show">
										<input type="radio" name="voice_orientation" value="1" <c:if test="${groupclass.voice_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
								<li class="list-group-item" id="yuyi_checkbox_box_update">
							...
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									...
									<label class="dib" id="music_checkbox_ctrl_hide">
										<input type="radio" name="music_orientation"  value="0" <c:if test="${groupclass.music_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label class="dib" id="music_checkbox_ctr2_show">
										<input type="radio" name="music_orientation" value="1" <c:if test="${groupclass.music_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
								<li class="list-group-item" id="music_checkbox_box_update">
							...
							<ul class="list-group">
								...
								class="dib" id="device_checkbox_ctr1_hide">
										<input
									type="radio" name="equipment_orientation" value="0" <c:if test="${groupclass.equipment_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="device_checkbox_ctr2_show">
										<input
									type="radio" name="equipment_orientation" value="1"<c:if test="${groupclass.equipment_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
							...
							<ul class="list-group">
								...
								class="dib" id="terminal_checkbox_ctr1_hide">
										<input
									type="radio" name="terminal_orientation" value="0" <c:if test="${groupclass.terminal_orientation==0}">checked</c:if> >不限</label>
									&nbsp;&nbsp;&nbsp;
									<label
								class="dib" id="terminal_checkbox_ctr2_show">
										<input
									type="radio" name="terminal_orientation" value="1"<c:if test="${groupclass.terminal_orientation==1}">checked</c:if> >自定义</label>
									&nbsp;&nbsp;&nbsp;
								</li>
