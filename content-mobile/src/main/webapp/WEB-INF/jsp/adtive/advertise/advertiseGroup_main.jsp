    ...
    <body>
		<!-- 正文 -->
				<div class="line-title">
					<span class="glyphicon glyphicon-list-alt"></span> 当前广告组：${groupName }
				...
				<div class="data-show-panel">
					<div class="data-box">
						<p class="mb10">展示次数</p>
						<p class="green">${allGroupMap.adv}</p>
					</div>
					<div class="data-box">
						<p class="mb10">点击次数</p>
					    <p class="yellow">${allGroupMap.ck}</p>
					</div>
					<div class="data-box">
						<p class="mb10">点击率</p>
                        <p class="orange">${allGroupMap.ckrate}%</p>
					</div>
					<div class="data-box">
						<p class="mb10">点击费用/次</p>
						<p class="orange">${allGroupMap.onceCkMoney}</p>
					</div>
					<div class="data-box">
						<p class="mb10">千次展示费用</p>
						<p class="red">${allGroupMap.tausendmalMoney}</p>
					</div>
					<div class="data-box">
						<p class="mb10">费用</p>
						<p class="red">${allGroupMap.charge}</p>
					</div>
				</div> 
				...
				<table class="table1  ml10" cellpadding="1" cellspacing="0"  border="1" >
					...
					<tbody>
						<c:forEach items="${groupList}" var="data">
							<tr>
								<td>${data.ctime}</td>
								<td>${data.charge}</td>
								<td>${data.adv}</td>
