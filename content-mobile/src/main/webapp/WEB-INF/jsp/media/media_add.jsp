...
<head>
	...
	<style type="text/css">
		...
		.bg-gray label{margin-right:10px;}
	</style>
</head>
<body style="font-family:'微软雅黑';">
	<!-- 正文开始-->
		<div class="main-right">
			<form method="post" action="media/addmedia.html" enctype="multipart/form-data" id="formtable">
			<input type="hidden" id="media" value="" name="media">
			<input type="hidden" id="mediapid"  name="mediapid">
					...
					<div class="list-group">
						...
						<div class="list-group-item adgroup-add-body-box" id="list-group-i">
							<p class="mt5">
								<span class="red">*</span>
								媒体名称：
								<input type="text" name="medianame" id="groupName" class="form-control">
							</p>
							<p class="mt5">
								<span class="red">*</span>
								媒体图标：
								<input type="file"  name="file"  value="上传图片" style="width:200px;text-align:center;cursor:pointer;">
							...
							<p class="mt5">
								<span class="red">*</span>
								优化目标：
								<label class="dib"><input type="checkbox" name="optimal" value="1"/>CPC</label>
								&nbsp&nbsp&nbsp
								<label class="dib"><input type="checkbox" name="optimal" value="2"/>CPM</label>
								&nbsp&nbsp&nbsp
								<label class="dib"><input type="checkbox" name="optimal" value="3"/>CPA</label>
								&nbsp&nbsp&nbsp
								<label class="dib"><input type="checkbox" name="optimal" value="4"/>CTR</label>
								&nbsp&nbsp&nbsp
								<label class="dib"><input type="checkbox" name="optimal" value="5"/>品牌好感度</label>
								&nbsp&nbsp&nbsp
								<label class="dib"><input type="checkbox" name="optimal" value="6"/>阅读量</label>
							</p>
						</div>
						<div class="list-group-item adgroup-add-head-box"> <b>竞品</b></div>
						...
						<div class="list-group-item adgroup-add-head-box"> <b>场景</b>
						</div>
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="713">交通类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="714">运动类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="715">建筑/景点类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="716">娱乐类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="717">生活类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="718">服务类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="719">工作类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="720">通用/设施类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="721">农耕类</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="722">自然经管类</label>
								</li>
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="723">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="752">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="773">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="655">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="841">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="868">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="883">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="891">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="903">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="912">全部</label>
										<label class="dib">
						...
						<div class="list-group-item adgroup-add-head-box"> <b>人物</b>
						</div>
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="931">明星</label>
								</li>
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
						...
						<div class="list-group-item adgroup-add-head-box"> <b>频道</b>
						</div>
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="1026">央视</label>
									<label class="dib" id="shipin_checkbox_ctr2_show">
										<input type="checkbox" name="medialabelone" value="1027">上星卫视（32家）</label>
									<label class="dib" id="dianbo_checkbox_ctr3_show">
										<input type="checkbox" name="medialabelone" value="1028">卫视以下地方台</label>
									<label class="dib" id="dianbo_checkbox_ctr3_show">
										<input type="checkbox" name="medialabelone" value="1029">其他</label>
								</li>
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox" name="medialabelone" value="1030">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox"  name="medialabelone" value="1048">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox"  name="medialabelone" value="1080">全部</label>
										<label class="dib" style="font-size:12px;">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox"  name="medialabelone" value="1100">全部</label>
										<label class="dib">
						...
						<div class="list-group-item adgroup-add-head-box"> <b>视频分类</b></div>
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="1158">技能型</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="1159">搞笑型</label>
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="1160">专项型</label>
								</li>
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox"  name="medialabelone" value="1161">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox"  name="medialabelone" value="1167">全部</label>
										<label class="dib">
								...
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
										<input class="groupCkQuanX1" type="checkbox"  name="medialabelone" value="1171">全部</label>
										<label class="dib">
											<input type="checkbox" name="medialabelone" value="1172">宠物</label>
										<label class="dib">
											<input type="checkbox" name="medialabelone" value="1173">时尚</label>
										<label class="dib">
											<input type="checkbox" name="medialabelone" value="1174">萌宝</label>
										<label class="dib">
											<input type="checkbox" name="medialabelone" value="1175">美食</label>
										<label class="dib">
											<input type="checkbox" name="medialabelone" value="1176">其他港台</label>
									</div>
								</li>
							</ul>
						</div>
						<div class="list-group-item adgroup-add-head-box"> <b>点播类别</b></div>
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="1177">全部</label>
								</li>
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
						...
						<div class="list-group-item adgroup-add-head-box"> <b>栏目</b></div>
						<div class="list-group-item adgroup-add-body-box">
							<ul class="list-group">
								<li class="list-group-item bg-gray">
									<label class="dib" id="zhibo_checkbox_ctrl_show">
										<input type="checkbox" name="medialabelone" value="1212">全部</label>
								</li>
								<li class="list-group-item nrBox" >
									<div>
										<label class="dib">
						...
						<div class="list-group-item adgroup-add-head-box"> <b>媒体资源</b></div>
						<div class="list-group-item adgroup-add-body-box mediaZy">
							...
							<div id="addBox" style="border:solid 1px #ccc; padding:20px;display:inline-block;display:none; margin-top:30px;">
								<p>资源描述：<input type="text" name="mediasname" id="mediasname" class="miaoshu" style="width:400px;" /></p>
								<p>创意尺寸：&nbsp&nbsp&nbsp宽：<input name="whight" class="kuan" type="text" style="width:60px;margin-right:25px;"/>
									高：<input name ="hight" class="gao"  type="text" style="width:60px;"/>
								</p>
								<p id="geshi">创意类型：&nbsp&nbsp&nbsp
									<label class="dib" style="width:70px;">
										<input name="ptype" type="checkbox" value="JPG">JPG
									</label>
									<label class="dib" style="width:70px;">
										<input name="ptype" type="checkbox" value="PNG">PNG
									</label>
									<label class="dib" style="width:70px;">
										<input name="ptype" type="checkbox" value="GIF">GIF
									</label>
								</p>
								<p style="text-align:center;"><span class="baocun" style="padding:5px 7px;border:solid 1px #ccc; display:inline-block;cursor:pointer;margin-top:20px;" id="butsver">保存</span></p>
							</div>
						</div>
						<div class="tc mt20">
