			                ...
			                <form action="role/save.html" onsubmit="return checkData()" method="post" name="myform" >
				                <table class="table-detail">
				                    <tr>
										<th>角色名称</th>
										<td>
											<input type="text" name="roleName" id="roleName" class="form-control" value="${role.roleName}">
											<span style="color:red" id="checkRoleName">*</span>
										</td>
				                    </tr>
				                    <%--<tr>--%>
										<%--<th>角色权限描述:</th>--%>
								...
								<input type="hidden" value="${role.id}" name="id" id="menuIdList"/>
			                </form>
			              </div>
			            </div>
			          </td>
